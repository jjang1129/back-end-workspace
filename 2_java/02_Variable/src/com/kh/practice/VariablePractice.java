...
public class VariablePractice {
	...
	public void method1() {
	 int adult = 10000;
	 int child = 7000;
	 System.out.println(2*adult+3*child);
	...
	public void method6() {
		...
		System.out.print("문자 : ");
		char a = scss.nextLine().charAt(0); // 입력받은 문자 ex) A 
		
		int b = a;  // 입력받은 문자의 유니코드 ex) 65
	    int c = b+1;
	    char d = (char)c;
	    int f = d;
		...
		System.out.println(d+" unicode : "+ f);
	...
	public void method7() {
		...
		System.out.print("국어 : ");
		double a =Double.parseDouble(scss1.nextLine());
		System.out.print("영어 : ");
		double b =Double.parseDouble(scss1.nextLine());
		System.out.print("수학 : ");
		double c =Double.parseDouble(scss1.nextLine());
		System.out.println("총점 : "+(a+b+c));
		System.out.printf("평균 : %.2f ",(a+b+c)/3);
