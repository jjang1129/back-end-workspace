...
INSERT INTO book(bk_title,bk_author,bk_price,bk_pub_no)
VALUES ('1일1로그 100일 완성 IT지식','브라이언W. 커니핸','200000','2');
...
CREATE TABLE MEMBER(
		member_no INT PRIMARY KEY AUTO_INCREMENT,
          member_id VARCHAR(20) NOT NULL UNIQUE,  -- 중복 금지
          member_pwd VARCHAR(20) NOT NULL,
          member_name VARCHAR(10) NOT NULL,
          gender CHAR(1) CHECK(gender IN ( 'M','F')) NOT NULL,
           address VARCHAR(30),     
          phone VARCHAR (20),
          status CHAR(1) CHECK(status IN('N','Y')) DEFAULT 'N',     -- 기본값 'N' / 'Y' 혹은 'N'만 입력되도록 제약조건
...
ALTER TABLE rent ADD CONSTRAINT rent_mem_no_f 
FOREIGN KEY(rent_mem_no) REFERENCES member(member_no) ON DELETE SET NULL ;

ALTER TABLE rent ADD CONSTRAINT rent_book_no_f 
