...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/reset(4).css" />
  ...
  <body>
    ...
    <main>
      ...
      <div class="main-content">
        ...
        <video src="${video.videoUrl}" controls="controls"></video>
       <img style="width: 200px" style="heigth: 200px" src="${video.videoImg}"></video>
        <p>${video.channel.channelName}- ${video.videoTitle}</p>
